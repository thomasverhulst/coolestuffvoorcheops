...
public class SalaryPackageService_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "SalaryPackageService";
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(SalaryPackageService_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "SalaryPackageRepository",
      "org.springframework.beans.factory.annotation.Autowired",
      "SalaryPackage",
      "SalaryPackageService",
      "org.springframework.data.repository.CrudRepository",
      "ISalaryPackageService"
    );
  } 
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("SalaryPackageRepository", false, SalaryPackageService_ESTest_scaffolding.class.getClassLoader()));
  }
